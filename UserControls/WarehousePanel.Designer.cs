namespace ZX_WareHouse.UserControls
{
    partial class WarehousePanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewCellStyle7.BackColor = Color.FromArgb(43, 42, 41);
            dataGridViewCellStyle7.ForeColor = Color.White;
            dataGridViewCellStyle7.SelectionBackColor = Color.FromArgb(224, 224, 224);
            dataGridViewCellStyle7.SelectionForeColor = Color.FromArgb(43, 42, 41);
            dataGridViewCellStyle7.WrapMode = DataGridViewTriState.True;
            ProductGridView.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle7;
            ProductGridView.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            ...
            dataGridViewCellStyle8.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point);
            dataGridViewCellStyle8.ForeColor = SystemColors.WindowText;
            dataGridViewCellStyle8.SelectionBackColor = Color.FromArgb(43, 42, 41);
            dataGridViewCellStyle8.SelectionForeColor = SystemColors.HighlightText;
            dataGridViewCellStyle8.WrapMode = DataGridViewTriState.True;
            ProductGridView.RowHeadersDefaultCellStyle = dataGridViewCellStyle8;
            ProductGridView.RowHeadersVisible = false;
            dataGridViewCellStyle9.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridViewCellStyle9.BackColor = Color.FromArgb(43, 42, 41);
            dataGridViewCellStyle9.ForeColor = Color.White;
            dataGridViewCellStyle9.SelectionBackColor = Color.FromArgb(43, 42, 41);
            dataGridViewCellStyle9.SelectionForeColor = Color.White;
            dataGridViewCellStyle9.WrapMode = DataGridViewTriState.False;
            ProductGridView.RowsDefaultCellStyle = dataGridViewCellStyle9;
